...
class SettingsMenu():
        ...
        def Start(self):
            if not self.looping:
                ...
                self.UIs["SaveAttributesButton"] = Text("Save", Vector2(inputOffsetX/2,self.UIs["EnterNameText"].GetPosPercent().y+5), 20, (255,255,255), bgColor=(20,30,40,255), underItems=[infoSave])
